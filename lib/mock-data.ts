...
export const projects: Project[] = [
  {
    id: "sneeze",
    title: "sneeze",
    description: "Personal developer ecosystem running on a single Vercel project with subdomain-based routing. Includes: Projects, Lab, Bot Builder, News, Status, and Links.",
    ...
    pushedAt: "2026-05-04T20:50:00Z",
  },
  {
    id: "discord-bot-builder",
    title: "Discord Bot Builder",
    description: "Visual code generator for creating production-ready Discord.py bots. Features templates, command builder, event system, live code preview, and ZIP export.",
    tags: ["Next.js", "TypeScript", "Discord"],
    url: "https://dbb.cjhauser.me",
    status: "active",
    stars: 0,
    languageColor: "#3178c6",
    pushedAt: "2026-05-04T21:00:00Z",
  },
  {
    id: "signal-news",
    title: "Signal News",
    description: "Full-stack news site with Supabase backend, newsletter generation, batch article processing, and web search integration via Perplexity.",
    tags: ["Next.js", "TypeScript", "Supabase"],
    url: "https://news.cjhauser.me",
    status: "active",
    stars: 0,
    languageColor: "#3178c6",
    pushedAt: "2026-05-04T20:50:00Z",
  },
  {
    id: "cloudcompile",
    title: "CloudCompile",
    description: "GitHub organization for open-source tools, experiments, and collaborative side projects.",
    tags: ["Open Source", "GitHub"],
    url: "https://github.com/CloudCompile",
    status: "active",
    stars: 8,
    languageColor: "#cccccc",
    pushedAt: "2026-05-04T20:00:00Z",
  },
];
